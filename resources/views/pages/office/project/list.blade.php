    ...
    <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
        <thead>
            <tr class="fw-bolder text-muted">
                ...
                <th class="max-w-150px">Nama Project</th>
                <th class="max-w-150px">Deskripsi</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <div class="d-flex align-items-center">
                        <span class="symbol symbol-50px">
                            <span class="symbol-label" style="background-image:url('{{ asset('storage/'.$item->image) }}');"></span>
                        </span>
                ...
                <td>
                    <span class="fw-bolder text-dark">{{ $item->deskripsi_project }}</span>
                </td>
                <td class="pe-0">
                    <div class="btn-group" role="group">
                        ...
                        <div class="dropdown-menu menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" aria-labelledby="aksi">
                            <div class="menu-item px-3">
                                <a href="javascript:;" onclick="load_input('{{route('project.edit',$item->id)}}');" class="menu-link px-3">Ubah</a>
                            </div>
                            <div class="menu-item px-3">
                                <a href="javascript:;" onclick="handle_delete('{{route('project.destroy',$item->id)}}');" class="menu-link px-3">Hapus</a>
                            </div>
                        </div>
                    </div>
                </td>
